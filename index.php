...
session_start();
  ...
  $queryPendidikan= mysqli_query($connection, "SELECT * FROM pendidikan");
  $queryPengalaman= mysqli_query($connection, "SELECT * FROM pengalaman");
    ...
    <div class="wrapper">
      <div class="sidebar">
        <div class="sidebar-header">
          <img src="img2/foto02.jpeg" alt="Image" />
        </div>
      ...
      <div class="content">
        ...
        <div class="header" id="header">
          <div class="content-inner">
            ...
            <h1>Rizky Hakiki</h1>
            <h2></h2>
            <div class="typed-text">Junior Fullstack Development.</div>
          </div>
        </div>
        <!-- Header End -->
                    ...
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 col-lg-5">
                                <img src="img2/kekal01.jpeg" alt="Image">
                            </div>
        ...
        <div class="education" id="education">
          <div class="content-inner">
            ...
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="edu-col">
                  <span><?php echo ($rowPendidikan['tahun_masuk']) ?><i>to</i><?php echo ($rowPendidikan['tahun_keluar']) ?></span>
                  <h3><?php echo ($rowPendidikan['tingkat_pendidikan'])?></h3>
                  <p>
                    <?php echo ($rowPendidikan['deskripsi']) ?>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="experience" id="experience">
          <div class="content-inner">
            ...
            <div class="row align-items-center">
              <div class="col-md-6">
                <?php while($resultPengalaman = mysqli_fetch_assoc($queryPengalaman)) :?>
                <div class="exp-col">
                  <span><?php echo $resultPengalaman['tahun_masuk'] ?><i>to</i><?php echo $resultPengalaman['tahun_keluar']  ?></span>
                  <h3><?php echo $resultPengalaman['nama_tempat'] ?> </h3>
                  <h4>
                  <?php echo $resultPengalaman['alamat'] ?>
                  </h4>
                  <h5><?php echo $resultPengalaman['deskripsi'] ?></h5>
                  <p>
                  <?php echo $resultPengalaman['jenis_perkerjaan'] ?>
                  </p>
                </div>
                <?php endwhile ?>
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <ul id="portfolio-flters">
                  ...
                  <li data-filter=".dig-mar">Network</li>
                </ul>
              </div>
            </div>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item web-des">
                <div class="portfolio-wrap">
                  <figure>
                    ...
                    ></a>
                    <a class="portfolio-title" href="#"
                      >Project Name <span>Design</span></a
                    >
                  </figure>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item dig-mar">
                <div class="portfolio-wrap">
                  <figure>
                    ...
                    ></a>
                    <a class="portfolio-title" href="#"
                      >Project Name <span>Network</span></a
                    >
                  </figure>
                </div>
              </div>
            ...
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="contact-info">
                  <p><i class="fa fa-user"></i>Rizky Hakiki</p>
                  <p><i class="fa fa-tag"></i>Junior Fullstack Development</p>
                  <p>
                  ...
                  <p>
                    ...
                    ><a href="tel:+1234567890">+62 896 1567 4013</a>
                  </p>
                  <p>
                    <i class="fa fa-map-marker"></i>JL. D Karang Anyar, Jakarta
                    Pusat
                  </p>
                  <div class="social">
          ...
          <div class="content-inner">
            <div class="row align-items-center">
              <div class="col-md-6">
                <p>
                  &copy; Copyright
                  <a href="https://www.youtube.com/">Mrzkyhakiki</a>. All Rights
                  Reserved
                </p>
              </div>
              <div class="col-md-6">
                <p>Powered by <a href="https://www.youtube.com/">HTML Codex</a></p>
              </div>
            </div>
          </div>
        </div>
